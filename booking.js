...
(function () {
  ...
  var BOOKING_CONFIG = {
    yard: {
      options: [
        { name: 'Private Lesson', detail: 'One-to-one flatwork, your own horse', url: '' },
        { name: 'Clinic Place', detail: 'Group session at Cork Farm', url: '' },
        { name: 'Yard Visit', detail: 'Livery, producing & sales enquiries', url: '' }
      ]
    },
    online: {
      options: [
        { name: 'Live Zoom Session', detail: 'Ride while Joseph coaches in real time', url: '' },
        { name: 'Video Analysis Review', detail: 'Talk through your feedback report', url: '' }
      ]
    }
  };
